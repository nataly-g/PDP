...
export default class Library {
    ...
    add(title, author, year, isAvailable = true) {
        ...
        if (existingBook) {
            console.log(`The book "${title}" by ${author} already exists in the library.`);
            return;
        }
    ...
    search(searchValue) {
        const searchResults = this.books.filter((book) => book.title.toLowerCase().includes(searchValue.toLowerCase()) ||
